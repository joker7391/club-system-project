...
const ARTESevents = () => {
  ...
  useEffect(() => {
    const fetchSsaClubEvents = async () => {
      ...
      try {
        ...
        const ssaClubQuery = query(eventsCollection, where("club", "==", "2"));
  ...
  return (
    <div className="container mx-4 py-12 px-4 lg:px-8">
      {loading ? (
        ...
        <p className="text-center text-lg text-gray-500">
          No events available for ARTES Club.
        </p>
      ) : (
