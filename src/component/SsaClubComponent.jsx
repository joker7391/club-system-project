...
const SsaClubComponent = () => {
  return (
    <div className="min-h-[100vh] bg-[#e0e04b] flex justify-center items-center w-full lg:w-auto">
      <div className="py-20 flex flex-col items-center gap-10">
        <h1 className="text-[#1c1c1c] font-serif text-md lg:text-3xl text-center w-auto lg:w-[30em]">
          ...
          and camaraderie thrives. Join us on a journey of teamwork,
          sportsmanship, and lifelong memories.
        </h1>
      </div>
    </div>
  );
