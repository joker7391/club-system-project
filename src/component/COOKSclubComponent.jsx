  ...
  useEffect(() => {
    const fetchCOOKSClubEvents = async () => {
      ...
      try {
        ...
        const cooksClubQuery = query(eventsCollection, where("club", "==", "3"));
    ...
    <div className="min-h-screen bg-[#4abbe48b] flex justify-center items-center w-full lg:w-auto">
      <div className="py-20 flex flex-col items-center gap-10">
        <h1 className="text-[#1c1c1c] font-serif text-md lg:text-3xl text-center w-auto lg:w-[30em]">
          Cooks club is for those who love cooking. It is recommended for the
          CULINARY ARTS strand as it enhances their experience through exposure
          and training. Members get involved in food preparation for events in
          STI. Non-CULINARY ARTS students are also welcome to join and learn.
        </h1>
        ...
        <div className="container mx-auto py-12 px-4 lg:px-0">
          {loading ? (
            ...
            <p className="text-center text-lg text-gray-500">No events available for COOKS Club.</p>
          ) : (
