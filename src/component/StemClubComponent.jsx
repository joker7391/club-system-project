    ...
    <div className="min-h-screen bg-[#6df276] flex justify-center items-center w-full lg:w-auto">
      <div className="py-20 flex flex-col items-center gap-10">
        <h1 className="text-[#1c1c1c] font-serif text-md lg:text-3xl text-center w-auto lg:w-[30em]">
          STEM club is about exploring Science, Technology, Engineering, and Math.
          The STEM club hosts events like "Tagisan ng Talino sa Agham at Sipnayan" and
          the STEM-Tech Exhibit. Join us in exploring the wonders of STEM.
        </h1>
        ...
        <div className="container mx-auto py-12 px-4 lg:px-0">
          {loading ? (
            ...
            <p className="text-center text-lg text-gray-500">No events available for STEM Club.</p>
          ) : (
