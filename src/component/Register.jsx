  ...
  const Register = () => {
    ...
    return (
      ...
      >
        <div className="flex flex-col bg-[#c3aaaa7b] p-5 rounded-lg h-[26em] w-[30em] shadow-lg shadow-black">
          ...
          <form className="grid grid-cols-2 gap-4" onSubmit={handleSubmit}>
            <input
              ...
              type="email"
              className="px-3 py-2 border rounded-md col-span-1 w-full"
              placeholder="Email"
            />
            <input
              required
            ...
            <select
              ...
              className="px-3 py-2 border rounded-md col-span-1 w-full text-[#1c1c1c]"
            >
            ...
            <button
              type="submit"
              className="block col-span-2 py-2 font-poppins bg-yellow-400 border border-black rounded-md text-center text-black font-semibold"
            >
              Register
            </button>
          </form>
